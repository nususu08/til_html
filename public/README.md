...
- haeder 영역이 스크롤시 `position:fixed 되면서 높이가 반영안됨.`

```
position:fixed 라고 셋팅하면 높이값이 반영이 안됩니다.
강제로 main 영역의 상단에 공간을 padding-top 으로 적용
```
...
- 검색어로 `postCss Sorting:Run` 선택 : 편한 키 등록
